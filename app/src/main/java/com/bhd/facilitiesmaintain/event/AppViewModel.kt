...
class AppViewModel : BaseViewModel() {
    ...
    //App的账户信息
    var userinfo = com.kunminx.architecture.ui.callback.UnPeekLiveData.Builder<UserInfo>()
